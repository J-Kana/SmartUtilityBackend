...
exports.objectCreate = (req, res) => {
    try {
        let {body} = req
        clientLegal_Type.create(body).then(object=>{
            if (!object){
